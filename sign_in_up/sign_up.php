...
<body>
	<div class="login-box">
	  <h2>Đăng nhập</h2>
	  <form method="post" action="xu_li_dang_ki.php">
	    <div class="user-box">
	    ...
	    <div class="user-box">
	      <input type="password" id="mat_khau" name="nhap_lai_mat_khau" required >
	      <label>Nhập lại Mật khẩu</label>
	      <span id="error_mat_khau_nhap_lai" class="span_error"></span>
	    </div>
	    ...
	    <div align="center">
	    	<a href="#">
		      ...
		      <span></span>
		      <span></span>
		      <button style="background: none; border: none; color: white;"  onclick="return ok()">Đăng kí</button>
		    </a>
		</div>
	  </form >
	  <br><br>
	  <div align="center" style="border-top: 1px solid #87aaab; color: white">
	  	<p>Bạn đã có tài khoản? <a href="sign_in.php" style="color: white">Quay về đăng nhập!!</a></p>
	  </div>
	</div>
	<script type="text/javascript">
			function ok() 
			{
				...
				var ten_regex=/^[A-Za-z]{4,}$/;
				if(ten_regex.test(ten))
				{
					document.getElementById('error_ten').innerHTML='';
				} else
					{
						document.getElementById('error_ten').innerHTML='*họ tên không được để trông';
						check_error = true;
					}
				// email
