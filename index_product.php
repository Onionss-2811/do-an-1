	...
	<div class="tong">
		...
		<br><br><br><br><br><br><br><br><br><br>
			<?php 
				...
				// lấy tất cả sản phẩm
				$sql = "select * from san_pham where san_pham.ten like '%$tim_kiem%' and trang_thai = 1 ORDER BY ma desc ";
			...
			<div class="menu_product">
				<table align="center">
					<tr align="center" style="background-color: #DDDDDD">
						<td>
							<a href="index_product.php">Tất cả sản phẩm</a>
						</td>
					</tr>
					<tr align="center" style="background-color: #DDDDDD">
						<td>
							<a href="index_product_sap_co.php">Sản phẩm sắp có</a>
						</td>
					</tr>
					<tr align="center" style="background-color: #DDDDDD">
						<td>
							<a href="index_product_gia_tang.php">Giá tăng dần</a>
						</td>
					</tr>
					<tr align="center" style="background-color: #DDDDDD">
						<td>
							<a href="index_product_gia_giam.php">Giá giảm dần</a>
						</td>
					</tr>
